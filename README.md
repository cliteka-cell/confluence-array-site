...
- Deep dark background (`#080808`) with animated star field and nebula glow
- Blue gradient accent (`#2060f0`) throughout
- Monospace font headers, glassmorphism cards
- Hover glow effects on feature cards, pricing cards, step cards, and OI signal cards (per-dot color)
- Fully responsive
